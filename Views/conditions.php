...
<div class="container">
    <div class="row">
        <div class="col-md-8 offset-md-2">
            ...
            <p>
                Ce site web est exploité par Bonnefête. Partout sur le site, nous employons les termes « nous », « notre » et « nos » en référence à Bonnefête. Ce site web, y compris l'ensemble des informations, outils et services auquel il donne accès, est offert par Bonnefête à l'utilisateur que vous êtes, à condition que vous acceptiez la totalité des modalités, conditions, politiques et avis stipulés ici.
            </p>
            <p>
            ...
            <h2 class="mt-5">SECTION 1 – CONDITIONS D'UTILISATION DE LA BOUTIQUE EN LIGNE</h2>
            <p>
            ...
            <h2 class="mt-5">SECTION 2 – CONDITIONS GÉNÉRALES</h2>
            ...
            <h2 class="mt-5">SECTION 3 – EXACTITUDE, EXHAUSTIVITÉ ET ACTUALITÉ DES INFORMATIONS</h2>
            ...
            <h2 class="mt-5">SECTION 4 – MODIFICATIONS DU SERVICE ET DES PRIX</h2>
            ...
            <h2 class="mt-5">SECTION 5 – PRODUITS OU SERVICES (le cas échéant)</h2>
            ...
            <h2 class="mt-5">SECTION 6 – EXACTITUDE DE LA FACTURATION ET DES INFORMATIONS DE COMPTE</h2>
            ...
            <h2 class="mt-5">SECTION 7 – OUTILS FACULTATIFS</h2>
            ...
            <h2 class="mt-5">SECTION 8 – LIENS DE TIERS</h2>
            ...
            <h2 class="mt-5">SECTION 9 – COMMENTAIRES, RETOURS D'EXPÉRIENCE ET AUTRES SOUMISSIONS</h2>
            ...
            <h2 class="mt-5">SECTION 10 – INFORMATIONS PERSONNELLES</h2>
            ...
            <h2 class="mt-5">SECTION 11 – ERREURS, INEXACTITUDES ET OMISSIONS</h2>
            ...
            <h2 class="mt-5">SECTION 13 – EXCLUSION DE GARANTIES ET LIMITATION DE RESPONSABILIT</h2>
            ...
            <h2 class="mt-5">SECTION 14 – INDEMNISATION</h2>
